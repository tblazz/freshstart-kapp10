      ...
      line += "<div class='theDate'>"
        ...
        line += "<ul class='list-inline'>"
          line += "<li>"
            ...
            line += "<div class='pull-right results-count'><div>#{ "#{event.editions.last.results.count} finisseurs" if event.editions.last.results.count > 0 }</div></div>"
          line += "</li>"
          line += "<li>"
            line =+ "<div class='pull-right results-button'><a class='btn btn-warning' onclick=\"displayResultsPage('#{ event.editions.last.widget_url }')\">Voir les résultats</a></div>"
          line += "</li>"
        line += "</ul>"
